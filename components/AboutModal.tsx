    ...
    <div className="about-modal open">
      ...
      <div className="about-content">
        ...
        <p className="about-heading">
          ...
          <br />
          <br />
          When we work together, I&apos;m immersed in your story, ruthless about what moves people,
          and built to close the gap between who you are and how the world sees you.
        </p>
        <div className="about-image">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/favicon.png" alt="Bitupan Borah" />
        </div>
        <div className="about-section">
          <h2 className="about-section-title"><span className="dot"></span>Clients</h2>
        ...
        <div className="about-section">
          <h2 className="about-section-title"><span className="dot"></span>Awards</h2>
          <div className="about-clients-grid">
        ...
        <div className="about-section">
          <h2 className="about-section-title"><span className="dot"></span>Principles</h2>
          <div className="about-values-grid">
            <div className="about-value-item">
              <h3 className="about-value-title">Performance first, aesthetics second</h3>
              <p className="about-value-desc">Every creative decision we make is interrogated against one question: does this actually serve your growth?</p>
            </div>
            <div className="about-value-item">
              <h3 className="about-value-title">All in or nothing</h3>
              <p className="about-value-desc">We take on fewer projects so we can give each one everything. When we commit to your brand, we&apos;re fully present, fully invested, fully responsible for the result.</p>
            </div>
            <div className="about-value-item">
              <h3 className="about-value-title">Human-first, always</h3>
              <p className="about-value-desc">Behind every brand is a person with a real story and real stakes. We never lose sight of that. The most powerful digital experiences are the ones that feel unmistakably human.</p>
            </div>
            <div className="about-value-item">
              <h3 className="about-value-title">Intention over speed</h3>
              <p className="about-value-desc">Rushed work compounds into regret. We move at the pace the work demands. Every layer earns its place before we move to the next.</p>
            </div>
          </div>
        </div>
      </div>
